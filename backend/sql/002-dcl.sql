...
-- Note: create BOTH '%' (remote TCP) AND 'localhost' (socket/named-pipe) —
--       MySQL treats them as separate user accounts and '%' does NOT match localhost.
...
--    Replicated for both '%' and 'localhost' hosts.
-- ============================================================================
